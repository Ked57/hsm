  ...
  setup() {
    return () => (
      <div id="Login" class="flex flex-col justify-center items-center">
        ...
        <input class="rounded-lg m-4 p-2 max-w-xl w-11/12 text-xl text-center h-16 bg-gray-400"></input>
        <span class="text-xl p-5 gradient-text">Security Code</span>
        <input type="password" class="rounded-lg m-4 p-2 max-w-xl w-11/12 text-xl text-center h-16 bg-gray-400"></input>
        <button
